...
def tune_decision_tree(data_X, data_y):
    ...
    max_depth_set = (500, 1000) #10000, 100000, None)
...
def get_raw_output_file_path():
    return os.path.join(get_results_dir_path(), "tuning_raw_output_dt_1.txt")


def get_tuning_results_file_path():
    return os.path.join(get_results_dir_path(), "tuning_output_dt_1.json")
